...
NUM_SIMULATIONS = 1000  # total de simulaciones únicas

os.makedirs("scratch/Estadisticas/Logs/", exist_ok=True)
os.makedirs("scratch/Estadisticas/Results_Finals/", exist_ok=True)
CSV_FILE = f"scratch/Estadisticas/Results_Finals/Simulations_Summary_{TOTAL_DEVICES}.csv"
...
def run_simulation(params):
    ...
    log_path = os.path.join("scratch/Estadisticas/Logs/", log_name)
...
# ================================
num_cpus = min(64, cpu_count()-2)  # usar hasta 64 núcleos
