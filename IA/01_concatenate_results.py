...
for f, file_path in tqdm(csv_files_info, desc="📄 Procesando CSV", unit="archivo"):
    try:
        ...
        data_filtered["Packet Size"] = PACKET_SIZE
        if 'nStaWifi' not in data_filtered.columns:
            data_filtered['nStaWifi'] = nStaWifi  # Asignar el valor a todas las filas
